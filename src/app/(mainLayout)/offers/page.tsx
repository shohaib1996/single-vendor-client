    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
        {productsData.map((product: IProduct, index: number) => (
          <Card
            key={product.id}
            className="group hover:shadow-xl dark:border-gray-400 transition-all duration-300 hover:-translate-y-2 animate-in slide-in-from-bottom-10 bg-card/50 backdrop-blur-sm border-border/50 p-0"
